"""
Django settings for bmk_tools project.
...
SECRET_KEY = "django-insecure-9a$g84u=&-_so*b@lzvr_2o@*n4q%17$b6*j2wlw!%#fj%!*$^"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "tickets.context_processors.tickets_admin",
            ],
        },
    },
]
...
# When DB_NAME env var is present (e.g. CI), use PostgreSQL; otherwise SQLite.
