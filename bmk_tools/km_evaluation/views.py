...
from km_evaluation.forms import ApplicantDetailsForm,AcademicQualificationForm,AcademicQualificationFormSet 
from formtools.wizard.views import SessionWizardView
from django.core.files.storage import FileSystemStorage
import os
import bmk_tools.settings as settings

# Create your views here.

def km_home_view(request):
    return render(request, "km_evaluation/home.html")
